...
\begin{enumerate}
  \item \autoref{sec:lec01}: \emph{Hva er strategi?} -- bevisst posisjonering
    ...
    (Chen, Bharadwaj).
  \item \autoref{sec:lec02}: \emph{Hvordan analysere?} -- \modelref{pestel}{PESTEL}, \modelref{five-forces}{Five Forces},
    \modelref{industry-lifecycle}{livssyklus}, \modelref{value-chain}{verdikjede}, \modelref{vrio}{VRIO}, \modelref{swot}{SWOT}, og katalog av strategiske virkemidler.
  \item \autoref{sec:lec03}: \emph{Hva er forretningsmodellen?} -- \modelref{cvp}{Johnson}, \modelref{weill-woerner}{Weill
    \& Woerner}s fire DBM-typer, \modelref{bmc}{BMC}, DVC.
  \item \autoref{sec:lec04}: \emph{Hvilken type endring?} -- \modelref{wessel}{Wessel et al.\
  ...
  \item \autoref{sec:lec06}: \emph{Verdikjede eller økosystem?} --
    \modelref{network-effects}{nettverkseffekter}, plattformstyring, three-dimensional chess, PBMC.
  \item \autoref{sec:lec07}: \emph{Hvordan implementere?} -- \modelref{tawse-tabesh}{Tawse \& Tabesh},
...
\begin{itemize}
  \item \emph{Porter} forteller hva strategi \emph{er} (posisjonering, valg,
    fit).
  \item \modelref{weill-woerner}{\emph{Weill \& Woerner}} forteller hvor virksomheten \emph{står}
    (DBM-type, customer knowledge).
  \item \emph{DVC} forteller hvor digital verdi \emph{kan oppstå}.
  \item \modelref{wessel}{\emph{Wessel et al.}} forteller hvilken \emph{type endring} digital
  ...
  \item \modelref{tawse-tabesh}{\emph{Tawse \& Tabesh}}, \emph{Miller}, \emph{Kotter},
